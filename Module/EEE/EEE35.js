  ...
  return (
    ...
    <View style={{height:'1%'}}/>
      ...
      <TouchableOpacity  onPress={()=> navigation.navigate('Home')}>
        ...
        <TouchableOpacity onPress={()=>  OpenAnything.Pdf('https://drive.google.com/file/d/1oGdt22GQ_RumIordOw3v9d01IwYLKAVv/view?usp=sharing')}>
                <Text style={btn}>Module 1
                </Text>
            </TouchableOpacity>
            
            <TouchableOpacity  onPress={()=> OpenAnything.Pdf('https://drive.google.com/file/d/1BiA6G4xmhqZ_fTYwIXZDEf5cncd-GUh8/view?usp=sharing')}>
